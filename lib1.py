...
# create table book info
        ...
        l1=Button(self.a,text='BOOK',font='Arial 22 bold',fg='Yellow',bg='Black',width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=500)
        l2=Button(self.a,text='STUDENTS',font='Arial 22 bold',fg='Yellow',bg='Black',width=19,padx=10,borderwidth=0,command=self.student).place(x=800,y=500)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Books',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.addbook).place(x=12,y=100)
        l2=Button(self.a,text='Search Books',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.search).place(x=12,y=200)

        l4=Button(self.a,text='Show List Book',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.all).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.mainmenu).place(x=12,y=500)
    ...
    def addbook(self):
        ...
        l1=Label(self.f1,text='Book ID : ',font='Arial 12 bold',fg='Orange',bg='Black',pady=1).place(x=50,y=50)
        e1=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.aid).place(x=150,y=50)
        l2=Label(self.f1,text='Title : ',font='Arial 12 bold',fg='Orange',bg='Black',pady=1).place(x=50,y=100)
        e2=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.aname).place(x=150,y=100)
        l3=Label(self.f1,text='Author : ',font='Arial 12 bold',fg='orange',bg='Black',pady=1).place(x=50,y=150)
        e3=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.aauthor).place(x=150,y=150)
        l4=Label(self.f1,text='Genre : ',font='Arial 12 bold',fg='orange',bg='Black',pady=1).place(x=50,y=200)
        e2=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.agenre).place(x=150,y=200)
        l4=Label(self.f1,text='Copies : ',font='Arial 12 bold',fg='orange',bg='Black',pady=1).place(x=50,y=250)
        e2=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.acopies).place(x=150,y=250)
        l5=Label(self.f1,text='Location : ',font='Arial 12 bold',fg='orange',bg='Black',pady=1).place(x=50,y=300)
        e3=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.aloc).place(x=150,y=300)
        self.f1.grid_propagate(0)
        b1=Button(self.f1,text='Add',font='Arial 10 bold',fg='black',bg='orange',width=15,bd=3,command=self.adddata).place(x=150,y=400)
        b2=Button(self.f1,text='Back',font='Arial 10 bold',fg='black',bg='orange',width=15,bd=3,command=self.rm).place(x=350,y=400)
...
# search methode
    def search(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID/Title/Author/Genre: ',font=('Arial 10 bold'),bd=2, fg='orange',bg='black').place(x=20,y=40)
        e1=Entry(self.f1,width=25,bd=5,bg='orange',fg='black',textvariable=self.sid).place(x=260,y=40)
        b1=Button(self.f1,text='Search',bg='orange',font='Arial 10 bold',width=9,bd=2,command=self.serch1).place(x=500,y=37)
        b1=Button(self.f1,text='Back',bg='orange',font='Arial 10 bold',width=10,bd=2,command=self.rm).place(x=250,y=450)
    ...
    def combo(self,event):
        ...
        #l7=Label(self.f1,text='copies to update: ',font='Arial 10 bold',bd=1).place(x=250,y=700)
...
# copie methode
    ...
    def copies(self,varr):
        try:
            ...
            if varr==0:
                b5=Button(self.f1,text='Update',font='Arial 10 bold',bg='orange',fg='black',width=9,bd=3,command=self.copiesadd).place(x=500,y=97)
            if varr==1:
                b6=Button(self.f1,text='Update',font='Arial 10 bold',bg='orange',fg='black',width=9,bd=3,command=self.copiesdelete).place(x=500,y=97)
        except:
            messagebox.showinfo("Empty","Please select something.")
    ...
    def student(self):
        self.a.destroy()
        self.a=self.canvases(image2)
        l1=Button(self.a,text='Issue book',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.issue).place(x=12,y=100)
        l2=Button(self.a,text='Return Book',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.returnn).place(x=12,y=200)
        l3=Button(self.a,text='Show List Students',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.activity).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Arial 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.mainmenu).place(x=12,y=600)
    ...
    def issue(self):
        ...
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='Arial 15 bold',bg='black',fg='orange').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='Arial 15 bold',bg='black',fg='orange').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Arial 10 bold',fg='black',bg='orange',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Issue',font='Arial 10 bold',fg='black',bg='orange',width=10,bd=3,command=self.issuedbook).place(x=200,y=250)
    ...
    def returnn(self):
        ...
        self.f1=Frame(self.a,height=550,width=500,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='Arial 15 bold',fg='orange', bg='black').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='Arial 15 bold',fg='orange', bg='black').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Arial 10 bold',bg='orange',fg='black',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Return',font='Arial 10 bold',bg='orange',fg='black',width=10,bd=3,command=self.returnbook).place(x=200,y=250)
        self.f1.grid_propagate(0)
    ...
    def activity(self):
        ...
        l1=Label(self.f1,text='Book/Student ID : ',font='Arial 15 bold',fg='Orange',bg='black').place(x=50,y=30)
        e1=Entry(self.f1,width=20,bd=4,bg='orange',textvariable=self.aidd).place(x=280,y=35)
        l2=Label(self.f1,text='Student Id : ',font='Arial 15 bold',fg='orange',bg='black').place(x=50,y=80)
        Fe2=Entry(self.f1,width=20,bd=4,bg='orange',textvariable=self.astudentt).place(x=180,y=80)
        b1=Button(self.f1,text='Back',bg='orange',font='Arial 10 bold',width=10,bd=3,command=self.rm).place(x=340,y=450)
        b1=Button(self.f1,text='Search',bg='orange',font='Arial 10 bold',width=10,bd=3,command=self.searchact).place(x=40,y=450)
        b1=Button(self.f1,text='All',bg='orange',font='Arial 10 bold',width=10,bd=3,command=self.searchall).place(x=190,y=450)
        b1=Button(self.f1,text='check overdue',bg='orange',font='Arial 10 bold',width=12,bd=3,command=self.check_overdue_books).place(x=180,y=500)
        self.f1.grid_propagate(0)
    ...
    def check_overdue_books(self):
        ...
        cursor.execute("SELECT BOOK_ID, RETURN_DATE FROM book_issued WHERE RETURN_DATE < date('now')")
        overdue_books = cursor.fetchall()

        if overdue_books:
            today = datetime.now()
            overdue_book_info = []
            for book_id, return_date in overdue_books:
                return_date = datetime.strptime(return_date, "%Y-%m-%d")
                days_overdue = (today - return_date).days
                overdue_book_info.append((book_id, days_overdue))

            # Display overdue books in a message box
            messagebox.showinfo("Overdue Books", "\n".join([f"Book ID: {book_id}, Days Overdue: {days_overdue}" for book_id, days_overdue in overdue_book_info]))
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('sharad', 'root')")
        conn.commit()
...
#LABELS
lbl_title = Label(canvas, text = "ADMIN   LOGIN", font=('Arial', 30,'bold', ),bg='black', fg='orange')
lbl_title.place(x=500,y=100)
lbl_username = Label(canvas, text = "Username:", font=('Arial', 15,'bold'),bd=4,bg='black', fg='orange')
lbl_username.place(x=500,y=230)
lbl_password = Label(canvas, text = "Password :", font=('Arial', 15,'bold'),bd=3, bg='black', fg='orange')
...
#BUTTON WIDGETS
btn_login = Button(canvas, text="LOGIN", font=('Arial 15 bold'),width=25,command=Login, bg='black', fg='orange')
